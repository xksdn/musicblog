...
public class Posts {
  ...
  public static String getUploadDir() {
    ...
    if (osName.contains("win")) { // Windows
      path = "C:\\kd\\deploy\\musicblog\\contents\\storage\\";
      // System.out.println("Windows: " + path);
    } else if (osName.contains("mac")) { // MacOS
      path = "/Users/yourusername/deploy/musicblog/contents/storage/";
      // System.out.println("MacOS: " + path);
    } else { // Linux
      path = "/home/ubuntu/deploy/musicblog/contents/storage/";
