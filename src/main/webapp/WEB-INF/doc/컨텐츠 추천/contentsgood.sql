...
CREATE TABLE postsgood (
    postsgoodno    NUMBER(10)        NOT NULL PRIMARY KEY,
    rdate            DATE        NOT NULL,
    post_no        NUMBER(10)        NOT NULL,
    user_no        NUMBER(10)        NOT NULL,
    FOREIGN KEY (post_no) REFERENCES music_post(post_no),
    FOREIGN KEY (user_no) REFERENCES user_info(user_no)
);


DROP SEQUENCE postsgood_seq;

CREATE SEQUENCE postsgood_seq
START WITH 1         -- 시작 번호
INCREMENT BY 1       -- 증가값
...
VALUES (contentsgood_seq.nextval, sysdate, 10, 1);

INSERT INTO contentsgood(contentsgoodno, rdate, contentsno, memberno)
VALUES (contentsgood_seq.nextval, sysdate, 11, 1);

INSERT INTO contentsgood(contentsgoodno, rdate, contentsno, memberno)
VALUES (contentsgood_seq.nextval, sysdate, 12, 1);

INSERT INTO contentsgood(contentsgoodno, rdate, contentsno, memberno)
VALUES (contentsgood_seq.nextval, sysdate, 15, 1);
...
SELECT contentsgoodno, rdate, contentsno, memberno
FROM contentsgood
WHERE contentsno=10 AND memberno=1;
