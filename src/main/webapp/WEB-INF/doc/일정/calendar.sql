...
CREATE TABLE calendar (
  calendarno  NUMBER GENERATED BY DEFAULT AS IDENTITY(START WITH 1 INCREMENT BY 1) PRIMARY KEY, -- AUTO_INCREMENT 대체
...
CREATE TABLE calendar (
  ...
  FOREIGN KEY (user_no) REFERENCES user_info (user_no) -- 일정을 등록한 관리자 
);
...
-- 데이터 삽입
INSERT INTO calendar(calendarno, labeldate, label, title, content, cnt, seqno, regdate, user_no)
